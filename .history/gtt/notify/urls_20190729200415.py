...
urlpatterns = [
    ...
    path(settings.API + 'notifications/mark_as_read', MarkAllAsRead.as_view(), name='mark_as_read'),
    path(settings.API + 'notifications/mark_all_as_unread', MarkAllAsUnread.as_view(), name='mark_all_as_unread'),
    path(settings.API + 'notifications/mark_as_unread', MarkAllAsUnread.as_view(), name='mark_as_unread'),
