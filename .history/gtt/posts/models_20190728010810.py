...
class Comment(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        try:
            Comment.objects.get(resource_key=resource_key)
...
class Reply(models.Model):
    ...
    def save(self, *args, **kwargs):
        resource_key = kwargs.get('resource_key')
        try:
            Reply.objects.get(resource_key=resource_key)
...
class Rating(models.Model):
    ...
    def save(self, *args, **kwargs):
        resource_key = kwargs.get('resource_key')
        try:
            Rating.objects.get(resource_key=resource_key)
...
class Bookmark(models.Model):
    ...
    def save(self, *args, **kwargs):
        resource_key = kwargs.get('resource_key')
        try:
            Bookmark.objects.get(resource_key=resource_key)
