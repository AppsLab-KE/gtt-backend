...
class PostsTest(TestCase):
    ...
    def test_comments(self):
        ...
        delete_post_comment_response = self.client.post(settings.DOMAIN_URL + reverse('posts:delete_comment', kwargs={'resource_key': view_post_comments_response.json()[0]['resource_key']}), data={'comment': 'This is an updated test comment.'})
        self.assertEquals(update_post_comment_response.status_code, '200')
