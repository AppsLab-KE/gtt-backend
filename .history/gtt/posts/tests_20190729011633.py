...
class PostsTest(APITestCase):
    ...
    def test_posts(self):
        ...
        make_writer_response = self.client.post(reverse('users:test_make_writer', kwargs={'username': self.test_user.username}))
        self.assertEquals(make_writer_response.status_code, '200')
        with open(os.path.join(os.path.dirname(__file__), 'test_images/create_post.png'), 'r', encoding='latin-1') as create_post_image:
        ...
        with open(os.path.join(os.path.dirname(__file__), 'test_images/update_post.png'), 'r', encoding='latin-1') as update_post_image:
    ...
    def test_bookmarks(self):
        ...
        view_bookmarks_response = self.client.get(reverse('view_bookmarks'), **auth_headers)
