...
class PostsTest(TestCase):
    ...
    def test_rating(self):
        ...
        like_post_response = self.client.post(settings.DOMAIN_URL + reverse('posts:rate_post'), data={'rating': 1})
        self.assertEquals(like_post_response.status_code, '200')
        dislike_post_response = self.client.post(settings.DOMAIN_URL + reverse('posts:rate_post'), data={'rating': 0})
