...
def unique_photo_path(instance, filename):
    ...
    return 'post_photos/{id}/{basename}{randomstring}{ext}'.format(id=instance.user.id, basename=basefilename, randomstring=randomstr, ext=file_extension)
...
class Post(models.Model):
    ...
    post_heading_image = models.ImageField(upload_to=unique_photo_path)
