...
urlpatterns = [
    ...
    path(settings.API + "posts/rated", ViewRatedPosts.as_view(), name='view_rated_post'),
    ...
    path(settings.API + "bookmarks/delete", DeleteBookmark.as_view(), name='delete_bookmark'),
]