...
class Comment(models.Model):
    commented_post = models.ForeignKey("Post", null=True, on_delete=models.SET_NULL)
    user_that_commented = models.ForeignKey("User", null=True, on_delete=models.SET_NULL)
...
class Reply(models.Model):
    replied_comment = models.ForeignKey("Comment", null=True, on_delete=models.SET_NULL)
    user_that_replied = models.ForeignKey("User", null=True, on_delete=models.SET_NULL)
...
class Rating(models.Model):
    rated_post = models.ForeignKey("Post", null=True, on_delete=models.SET_NULL)
    user_that_rated = models.ForeignKey("User", null=True, on_delete=models.SET_NULL)
...
class Bookmark(models.Model):
    user_that_bookmarked = models.ForeignKey("User", related_name='bookmark', null=True, on_delete=models.SET_NULL)
    bookmarked_post = models.ForeignKey("Post", related_name='post', null=True, on_delete=models.SET_NULL)
    resource_key = models.CharField(max_length=50, unique=True)
    archived = models.BooleanField(default=False)
