    ...
    def post(self, request, slug):
        ...
        try:
            ...
            if user.has_perm('delete_post', post):
                ...
                return Response({
                    "message": "That cannot delete that post.",
                }, status=status.HTTP_404_NOT_FOUND)
        except Post.DoesNotExist:
            return Response({
                "message": "That post was not found.",
    ...
    def post(self, request, resource_key):
        ...
        try:
            ...
            if user.has_perm('delete_comment', comment):
                ...
                return Response({
                    "message": "That cannot delete that comment.",
                }, status=status.HTTP_404_NOT_FOUND)
        except Comment.DoesNotExist:
            return Response({
                "message": "That comment was not found.",
    ...
    def post(self, request, resource_key):
        ...
        try:
            ...
            if user.has_perm('change_reply', reply):
                ...
                return Response({
                    "message": "That cannot update that reply.",
                }, status=status.HTTP_404_NOT_FOUND)
        except Comment.DoesNotExist:
            return Response({
    ...
    def post(self, request, resource_key):
        ...
        try:
            ...
            if user.has_perm('delete_reply', reply):
                ...
                return Response({
                    "message": "That cannot delete that reply.",
                }, status=status.HTTP_404_NOT_FOUND)
...
class DeleteBookmark(APIView):
    ...
    def post(self, request, resource_key):
        ...
        try:
            ...
            if user.has_perm('delete_bookmark', post):
                ...
                return Response({
                    "message": "That cannot delete that bookmark.",
                }, status=status.HTTP_404_NOT_FOUND)
        except Post.DoesNotExist:
            return Response({
