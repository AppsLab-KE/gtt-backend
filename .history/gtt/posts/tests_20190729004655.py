...
class PostsTest(APITestCase):
    ...
    def test_posts(self):
        ...
        with open('test_images/create_post.png') as create_post_image:
            ...
            create_post_response = self.client.post(reverse('posts:create_post'), data=create_post_data, **auth_headers)
        ...
        with open('test_images/update_post.png') as update_post_image:
            ...
            update_post_response = self.client.post(reverse('posts:update_post', kwargs={'slug': tag_posts_response.json()[0]['slug']}), data=update_post_data, **auth_headers)
