...
class PostsTest(APITestCase):
    ...
    def test_posts(self):
        ...
        with open(os.path.join(os.path.dirname(__file__), 'test_images/create_post.png'), 'rb', encoding='latin-1') as create_post_image:
        ...
        with open(os.path.join(os.path.dirname(__file__), 'test_images/update_post.png'), 'rb', encoding='latin-1') as update_post_image:
