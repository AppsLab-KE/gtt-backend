    ...
    def post(self, request):
        ...
        if user.has_perm('add_post'):
            ...
            if post_form.is_valid():
                ...
                return Response({
                    "details": "That post was not created.",
                }, status=status.HTTP_400_BAD_REQUEST)
        else:
            return Response({
                    "details": "You cannot create this post.",
        ...
        try:
            ...
            if user.has_perm('change_post', post):
                ...
                if post_form.is_valid():
                    ...
                    return Response({
                        "details": "That post was not updated.",
                    }, status=status.HTTP_400_BAD_REQUEST)
            else:
                return Response({
...
class DeletePost(APIView):
    ...
    def post(self, request, slug):
        ...
        try:
            post = Post.objects.get(slug=slug)
            if user.has_perm('delete_post', post):
        ...
        try:
            ...
            try:
                ...
                if rating_form.is_valid():
                    ...
                    return Response({
                        "details": rating_form.errors.as_json(),
                    }, status=status.HTTP_400_BAD_REQUEST)
            except Rating.DoesNotExist:
                return Response({
    ...
    def post(self, request, slug):
        ...
        try:
            ...
            if comment_form.is_valid():
                ...
                return Response({
                        "details": comment_form.errors.as_json(),
                    }, status=status.HTTP_400_BAD_REQUEST)
        except Post.DoesNotExist:
            return Response({
                "details": "That post was not found.",
...
class UpdateComment(APIView):
    ...
    def post(self, request, resource_key):
        ...
        try:
            ...
            if user.has_perm('change_comment', comment):
                comment_form = CommentForm({
                    'comment': comment,
                }, instance=comment)
                if comment_form.is_valid():
...
class DeleteComment(APIView):
    ...
    def post(self, request, resource_key):
        ...
        try:
            comment = Comment.objects.get(resource_key=resource_key)
            if user.has_perm('delete_comment', comment):
...
class CreateReply(APIView):
    ...
    def post(self, request, resource_key):
        ...
        try:
            comment = Comment.objects.get(resource_key=resource_key)
            reply = Reply.objects.create(replied_comment=comment, user_that_replied=user, reply=reply)
            assign_perm('change_reply', user, reply)
            assign_perm('delete_reply', user, reply)
            return Response({
...
class UpdateReply(APIView):
    ...
    def post(self, request, resource_key):
        ...
        try:
            ...
            if user.has_perm('change_reply', reply):
...
class DeleteReply(APIView):
    ...
    def post(self, request, resource_key):
        ...
        try:
            reply = Reply.objects.get(resource_key=resource_key)
            if user.has_perm('delete_reply', reply):
...
class CreateBookmark(APIView):
    ...
    def post(self, request, slug):
        ...
        try:
            ...
            assign_perm('change_bookmark', user, bookmark)
            assign_perm('delete_bookmark', user, bookmark)
            return Response({
...
class DeleteBookmark(APIView):
    ...
    def post(self, request, resource_key):
        ...
        try:
            ...
            if user.has_perm('delete_bookmark', bookmark):
